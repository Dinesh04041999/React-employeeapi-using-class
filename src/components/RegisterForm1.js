            ...
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    file: Yup.mixed()
                        ...
                        .test("fileType", "Suppoted file format .png and .jpg", async(file) => {
                            if (file) {
                                ...
                                if (this.props.data) {
                                    ...
                                    const url = await this.getBase64FromUrl(file).then(data => {
                                        let result = data;
                                        // console.log(result);
                                        const jpg = (result.substring("data:image".length, result.indexOf(";base64"))) === ("/jpg");
                                        const png = (result.substring("data:image".length, result.indexOf(";base64"))) === ("/png");
                                ...
                                if (!this.props.data) {
                                    if (file) {
                                        const jpg = (file.substring("data:image".length, file.indexOf(";base64"))) === ("/jpg");
                                        const png = (file.substring("data:image".length, file.indexOf(";base64"))) === ("/png");
                                        return (jpg || png)
                                    }
                                }
            ...
            >
                {({ setFieldValue, handleChange, handleBlur, values }) => (
                    <Form >
                        ...
                        {!this.props.data && <h3 style={{ textAlign: "center" }}>Registration page</h3>}
                        ...
                        <div className="row mt-5" style={{ height: "50px", padding: "5px", marginTop: "35px" }}>
                            ...
                            <div className="col-md-4">
                                ...
                                <Field type="text" name="id" id="id" autoComplete="off" disabled={true} onChange={handleChange}
                                    onBlur={handleBlur}
                            ...
                            <div className="col-md-4" style={{ padding: "0px ", border: "1px rgb(15, 15, 15) solid" }}>
                                <div className="short-div" style={{ position: "relative", zIndex: "1" }}>

                                    <img src={values.file} alt="" style={{ height: "300px", width: "375px" }} />
                        ...
                        <div className="row"
                            ...
                            <div className="col-md-4">
                                ...
                                <ErrorMessage name="employeename" component="div" className="text-danger" style={{marginLeft:"20px"}}/>
                            </div>
                            <div className="col-md-4">
                            </div>
                        </div>
                        ...
                        <div className="row"
                            ...
                            <div className="col-md-4">
                                ...
                                <ErrorMessage name="employeesalary" component="div" className="text-danger" style={{marginLeft:"20px"}}/>
                        ...
                        <div className="row"
                            ...
                            <div className="col-md-4">
                                ...
                                <ErrorMessage name="employeeage" component="div" className="text-danger"style={{marginLeft:"20px"}} />
                        ...
                        <div className="row"
                            ...
                            <div className="col-md-4">
                                ...
                                <ErrorMessage name="email" component="div" className="text-danger"style={{marginLeft:"20px"}} />
                            </div>
                            ...
                            <div className="col-md-3 mt-1">
                                ...
                                <ErrorMessage name="file" component="div" className="text-danger"style={{marginLeft:"20px"}} />
                        ...
                        <div className="row"
                            ...
                            <div className="col-md-4">
                                ...
                                <ErrorMessage name="designation" component="div" className="text-danger"style={{marginLeft:"20px"}} />
                            </div>
                            <div className="col-md-4">
